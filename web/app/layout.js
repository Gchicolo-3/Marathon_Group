        ...
        <header className="sticky top-0 z-10 border-b bg-slate-900 text-white">
          <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-6 px-6">
            ...
            <nav className="flex items-center gap-4 text-sm text-slate-300">
              ...
              <Link href="/signals" className="transition-colors hover:text-white">Signals</Link>
              <Link href="/activity" className="transition-colors hover:text-white">Activity</Link>
